        ...
        <tiles:putAttribute name="admin.body">
            ...
            <div class="tile-12 container">
                <h3 class="breadcrumbs title">
                    ...
                    <span class="breadcrumb-item">${editedTeam.teamName}</span>
                </h3>
            </div>
            
            <c:if test="${not empty success}">${success}</c:if>
            
            <form:form modelAttribute="editedTeam" class="edit-team-form" enctype="multipart/form-data">
                <div class="tile-6">
                    ...
                    <div class="form-input">
                        <label for="teamSlug">
                            Slug
                            <span class="help-block error">
                                <form:errors path="teamSlug" />
                            </span>
                        </label>
                        <form:input id="teamSlug" path="teamSlug" type="text" placeholder="american-psychos" />
                    </div>
                    <div class="form-input">
                        <label for="steamId">
                            Steam ID
                    ...
                    <div class="form-input checkbox">
                        <form:checkbox path="isDeleted" id="isDeleted"/>
                        <label for="isDeleted">
                            Deleted
                            <span class="help-block error">
                            </span>
