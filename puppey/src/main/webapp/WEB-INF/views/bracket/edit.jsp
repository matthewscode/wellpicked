...
<tiles:putAttribute name="pageId" value="edit bracket" /> 
<tiles:putAttribute name="pageTitle" value="Edit bracket - ${userTournamentPrediction.tournamentPredictionName}" />
...
<div class="well container" data-url="<c:url value="/api/tournament/${userTournamentPrediction.tournament.tournamentId}" />"
     data-ng-controller="TournamentController" data-ng-init="init({editBracket: '<c:url value="/api/prediction/${userTournamentPrediction.tournamentPredictionId}" />', bracketPath: '${bracketPath}'})" data-ng-cloak="true">
    ...
    <div class="information" data-ng-show="tournament" data-ng-bg-image="<c:url value="/resources/images/tournaments/${empty tournamentImage ? 'default' : userTournamentPrediction.tournament.tournamentSlug}.jpg"/>">
        <div class="wrapper">
            ...
            <div class="bracket-name">
                <input type="text" name="bracketName" data-ng-model="prediction.tournamentPredictionName" placeholder="Awesome bracket name" required>
            </div>
        </div>
    </div>
    ...
    <div class="submit-container text-center">
        <button type="button" data-ng-click="submitEditBracket('<c:url value="/api/predictions/save" />')">Edit bracket</button>
    </div>
</div>
