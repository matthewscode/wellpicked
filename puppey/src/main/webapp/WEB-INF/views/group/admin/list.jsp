...
<%-- Setting URL vars --%>
<spring:url value="/admin/pool/edit/" var="groupEditPath" htmlEscape="true" />

<tiles:insertDefinition name="main">
<tiles:putAttribute name="pageTitle" value="Admin - Groups" />
<tiles:putAttribute name="pageId" value="admin group list" />
                    ...
                    <div class="list-item">
                        <div class="tiles">
                            ...
                            <div class="tile-2 text-center">
                                <a href="${groupEditPath}${item.groupId}"><i class="icon">&#xE3C9;</i></a>
                            </div>
                        </div>
                    </div>
                </c:forEach>
