        ...
        <tiles:putAttribute name="admin.body">
            ...
            <div class="tile-12 container">
                <h3 class="breadcrumbs title">
                    ...
                    <span class="breadcrumb-item">Create GroupStage</span>
                </h3>
            </div>
            
            <form:form modelAttribute="groupStage" class="add-tournament-form clearfix" enctype="multipart/form-data">
                <div class="tile-6">
                 ...
                 <form:input id="numTeams" path="numTeams" type="text" placeholder="Number of Teams" />
                    </div>
