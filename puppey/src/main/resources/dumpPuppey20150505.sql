...
-- Table `puppey`.`users`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `puppey`.`users` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `puppey`.`authorities` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `puppey`.`tournament` ;

CREATE TABLE IF NOT EXISTS `puppey`.`tournament` (
  `t_id` INT(11) NOT NULL AUTO_INCREMENT,
  `t_name` VARCHAR(45) NOT NULL,
  `t_start` INT(11) NULL DEFAULT '0',
  `t_end` INT(11) NULL DEFAULT NULL,
  `t_num_matchups` INT(11) NULL DEFAULT NULL,
  `t_image` VARCHAR(255) NULL DEFAULT NULL,
  `t_thumb` VARCHAR(255) NULL DEFAULT NULL,
  `t_desc` VARCHAR(255) NULL DEFAULT NULL,
...
-- Table `puppey`.`team`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `puppey`.`team` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `puppey`.`matchup` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `puppey`.`matchup_team` ;
...
-- Table `puppey`.`round`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `puppey`.`round` ;
...
-- Table `puppey`.`status`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `puppey`.`status` ;
